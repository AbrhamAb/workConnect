...
func migrate(ctx context.Context, db *sql.DB) error {
	schema := `
		...
		CREATE INDEX IF NOT EXISTS idx_service_requests_customer_status_created ON service_requests(customer_id, status, created_at DESC);
		CREATE INDEX IF NOT EXISTS idx_service_requests_worker_status_created ON service_requests(worker_id, status, created_at DESC);
		CREATE INDEX IF NOT EXISTS idx_worker_skills_category_worker ON worker_skills(category_id, worker_id);
