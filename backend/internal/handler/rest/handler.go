...
type Handler interface {
	...
	ListCustomerFavorites(w http.ResponseWriter, r *http.Request)
	GetCustomerFavoriteStatus(w http.ResponseWriter, r *http.Request)
	AddCustomerFavorite(w http.ResponseWriter, r *http.Request)
	RemoveCustomerFavorite(w http.ResponseWriter, r *http.Request)
	...
	ListCustomerRequestPhotos(w http.ResponseWriter, r *http.Request)
	CreateCustomerRequestPhoto(w http.ResponseWriter, r *http.Request)
	DeleteCustomerRequestPhoto(w http.ResponseWriter, r *http.Request)
	ListWorkerRequestPhotos(w http.ResponseWriter, r *http.Request)
