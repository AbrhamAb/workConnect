...
type Handler interface {
	...
	AdminRequests(w http.ResponseWriter, r *http.Request)
	...
	ListWorkerDocuments(w http.ResponseWriter, r *http.Request)
	UploadWorkerDocument(w http.ResponseWriter, r *http.Request)
	SubmitWorkerVerification(w http.ResponseWriter, r *http.Request)
